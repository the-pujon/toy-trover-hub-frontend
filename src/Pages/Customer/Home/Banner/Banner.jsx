...
const Banner = () => {
  return (
    <div className="wrapper mx-auto banner flex items-center justify-center min-h-screen !pt-20">
      <aside className="responsive-banner second relative flex justify-between w-full flex-row gap-4">
        <div data-aos="fade-right" className="flex-1  text-white flex items-center lg:items-start text-center lg:text-start flex-col justify-center gap-4">
        ...
        <div data-aos="fade-left" className="flex-1 lg:flex items-center justify-center hidden">
          ...
          <svg data-aos="zoom-in" className="circle-a" height="200" width="200">
            <circle cx="100" cy="100" r="100" />
          </svg>
          <svg data-aos="zoom-in" className="circle-b" height="200" width="200">
            <circle cx="80" cy="80" r="80" />
          </svg>
          <svg data-aos="zoom-in" className="circle-c" height="200" width="200">
            <circle cx="80" cy="80" r="80" />
          </svg>
          <svg data-aos="zoom-in" className="circle-d" height="60" width="60">
